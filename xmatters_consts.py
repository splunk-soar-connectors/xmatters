...
XM_WHO_IS_ONCALL_TIME_FAILURE = "Provide both from and to value for timeframe"
XM_WHO_IS_ONCALL_FAILURE = "No Data Found"
XM_WHO_IS_ONCALL_INVALID_MEM_FAILURE = "Provide valid member per shift value (1 to 100)"
